...
def load_data(args, tasks):
    ...
    if args.subtask == "None":
        ...
        valid_queries = pickle.load(open(os.path.join(args.data_path, "valid--0-full-inf-queries.pkl"), 'rb'))
        valid_hard_answers = pickle.load(open(os.path.join(args.data_path, "valid--0-full-inf-hard-answers.pkl"), 'rb'))
        valid_easy_answers = pickle.load(open(os.path.join(args.data_path, "valid--0-full-inf-easy-answers.pkl"), 'rb'))

        test_queries = pickle.load(open(os.path.join(args.data_path, "test--0-full-inf-queries.pkl"), 'rb'))
        test_hard_answers = pickle.load(open(os.path.join(args.data_path, "test--0-full-inf-hard-answers.pkl"), 'rb'))
        test_easy_answers = pickle.load(open(os.path.join(args.data_path, "test--0-full-inf-easy-answers.pkl"), 'rb'))
    elif args.subtask == "4hops":
        valid_queries = pickle.load(open(os.path.join(args.data_path, "valid--0-4i4p-queries.pkl"), 'rb'))
        valid_hard_answers = pickle.load(open(os.path.join(args.data_path, "valid--0-4i4p-hard-answers.pkl"), 'rb'))
        valid_easy_answers = pickle.load(open(os.path.join(args.data_path, "valid--0-4i4p-easy-answers.pkl"), 'rb'))

        test_queries = pickle.load(open(os.path.join(args.data_path, "test--0-4i4p-queries.pkl"), 'rb'))
        test_hard_answers = pickle.load(open(os.path.join(args.data_path, "test--0-4i4p-hard-answers.pkl"), 'rb'))
        test_easy_answers = pickle.load(open(os.path.join(args.data_path, "test--0-4i4p-easy-answers.pkl"), 'rb'))
    else:
        ...
        test_queries = pickle.load(open(os.path.join(args.data_path, testsubtaskfolder+"/"+task+"/"+subtask+"/"+"test-queries.pkl"), 'rb'))
        test_hard_answers = pickle.load(open(os.path.join(args.data_path, testsubtaskfolder+"/"+task+"/"+subtask+"/"+"test-hard-answers.pkl"), 'rb'))
        test_easy_answers = pickle.load(open(os.path.join(args.data_path, testsubtaskfolder+"/"+task+"/"+subtask+"/"+"test-easy-answers.pkl"), 'rb'))
...
def main(args):
    ...
    if args.geo == 'cqd':
        if args.do_test: #load dictionaries containing for each query atom (q,r,?x) the links from the training data,i.e., if test ->train+valid, if valid->train
